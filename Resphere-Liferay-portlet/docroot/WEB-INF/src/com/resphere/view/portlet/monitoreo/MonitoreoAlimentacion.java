...
/**
 * Portlet implementation class MonitoreoAlimentacion
 */
public class MonitoreoAlimentacion extends MVCPortlet {
 
	private static Log _log = LogFactory.getLog(MonitoreoAlimentacion.class);
	@Override
	public void doView(RenderRequest renderRequest, RenderResponse renderResponse) throws IOException, PortletException{
	 ...
	 public void monitoreoDetails(ActionRequest actionRequest, ActionResponse actionResponse)throws IOException, PortletException, PortalException, SystemException{
			...
			List<Monitoreorespuesta> monitoreos = serviciom.getAllByIds(id, 2);
			...
			List<Respuestabysectorv> respuestav = servicior.getAllByIds(id, "2");
			...
			actionResponse.setRenderParameter("jspPage", "/html/monitoreoalimentacion/edit.jsp");
