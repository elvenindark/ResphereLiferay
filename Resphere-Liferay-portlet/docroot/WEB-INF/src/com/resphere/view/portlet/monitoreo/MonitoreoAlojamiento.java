...
/**
 * Portlet implementation class MonitoreoAlojamiento
 */
public class MonitoreoAlojamiento extends MVCPortlet {
 
	private static Log _log = LogFactory.getLog(MonitoreoAlojamiento.class);
	@Override
	...
	public void monitoreoDetails(ActionRequest actionRequest, ActionResponse actionResponse)throws IOException, PortletException, PortalException, SystemException{
		...
		List<Monitoreorespuesta> monitoreos = serviciom.getAllByIds(id, 3);
		...
		List<Respuestabysectorv> respuestav = servicior.getAllByIds(id, "3");
		...
		actionResponse.setRenderParameter("jspPage", "/html/monitoreoalojamiento/edit.jsp");
